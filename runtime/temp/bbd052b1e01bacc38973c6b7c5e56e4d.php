<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\active\index.html";i:1469516310;s:67:"D:\phpStudy\WWW\cms\public/../application/admin\view\base\base.html";i:1468380670;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\style.html";i:1468817574;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\loading.html";i:1468203746;s:68:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\nav.html";i:1468396422;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\sidebar.html";i:1468812703;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\script.html";i:1468808902;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\modal.html";i:1468203746;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\danger.html";i:1468227114;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="widget-body">
                        <div class="table-toolbar">
                          <?php if(in_array(38,$auth)): ?>
                            <a id="editabledatatable_new" href="<?php echo url('admin/active/add'); ?>" class="btn btn-default">
                                添加活动
                            </a>
                          <?php endif; ?>
                            ...
                            <tbody>
                               <?php if(is_array($actives) || $actives instanceof \think\Collection): $i = 0; $__LIST__ = $actives;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr class="success">
                                        ...
                                        <td class="text-left"><?php echo $vo['start_time']; ?></td>
                                        <td class="text-left"><?php echo $vo['end_time']; ?></td>
                                        <td>
                                            <?php if(in_array(39,$auth)): ?>
                                            <a class="btn btn-info btn-xs edit" href="<?php echo url('admin/active/edit',['id'=>$vo['id']]); ?>"><i class="fa fa-edit"></i>编辑</a>
                                            <?php endif; if(in_array(40,$auth)): ?>
                                            <a class="btn btn-danger btn-xs delete" href="javascript:activeDelete(<?php echo $vo['id']; ?>)"><i class="fa fa-trash-o"></i>删除</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <div><?php echo $actives->render(); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        function activeDelete(id)
        {
            bootbox.confirm("是否删除该活动", function (result) {
                if (result) {
                    $.ajax({
                        type: "POST",
                        url: '<?php echo url("admin/active/delete"); ?>',
                        dataType: 'json',
                        cache: false,
                        data:{id:id},
                        success: function(data) {
