<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:68:"D:\phpStudy\WWW\cms\public/../application/admin\view\page\index.html";i:1468811937;s:67:"D:\phpStudy\WWW\cms\public/../application/admin\view\base\base.html";i:1468380670;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\style.html";i:1468817574;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\loading.html";i:1468203746;s:68:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\nav.html";i:1468396422;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\sidebar.html";i:1468812703;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\script.html";i:1468808902;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\modal.html";i:1468203746;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\danger.html";i:1468227114;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="table-toolbar">
                          <?php if(in_array(28,$auth)): ?>
                            <a id="editabledatatable_new" href="<?php echo url('admin/Page/add'); ?>" class="btn btn-default">
                                添加文章
                            </a>
                          <?php endif; ?>                          
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                            ...
                            <tbody>
                                <?php if(is_array($pages) || $pages instanceof \think\Collection): $i = 0; $__LIST__ = $pages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr class="success">
                                        <td class="text-left"><?php echo $vo['id']; ?></td>
                                        <td class="text-left"><?php echo $vo['title']; ?></td>
                                        <td>
                                            <?php if(in_array(26,$auth)): ?>
                                            <a class="btn btn-info btn-xs edit" href="<?php echo url('admin/page/edit',['id'=>$vo['id']]); ?>"><i class="fa fa-edit"></i>编辑</a>
                                            <?php endif; if(in_array(27,$auth)): ?>
                                            <a class="btn btn-danger btn-xs delete" href="javascript:pageDelete(<?php echo $vo['id']; ?>)"><i class="fa fa-trash-o"></i>删除</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php if(is_array($vo->parent) || $vo->parent instanceof \think\Collection): $i = 0; $__LIST__ = $vo->parent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?>
                                    <tr class="success">
                                        <td class="text-left"><?php echo $ko['id']; ?></td>
                                        <td class="text-left">┗━<?php echo $ko['title']; ?></td>
                                        <td>
                                            <?php if(in_array(30,$auth)): ?>
                                            <a class="btn btn-info btn-xs edit" href="<?php echo url('admin/page/edit',['id'=>$ko['id']]); ?>"><i class="fa fa-edit"></i>编辑</a>
                                            <?php endif; if(in_array(29,$auth)): ?>
                                            <a class="btn btn-danger btn-xs delete" href="javascript:pageDelete(<?php echo $ko['id']; ?>)"><i class="fa fa-trash-o"></i>删除</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<!--End Success Modal Templates-->
    ...
    <script>
        ...
        {
            bootbox.confirm("是否删除该文章", function (result) {
                if (result) {
                    $.ajax({
                        type: "POST",
                        url: '<?php echo url("admin/Page/delete"); ?>',
                        dataType: 'json',
                        cache: false,
                        data:{id:id},
                        success: function(data) {
