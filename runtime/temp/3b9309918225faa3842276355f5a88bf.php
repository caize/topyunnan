<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:65:"D:\phpStudy\WWW\cms\public/../application/admin\view\ad\edit.html";i:1469435863;s:67:"D:\phpStudy\WWW\cms\public/../application/admin\view\base\base.html";i:1468380670;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\style.html";i:1468817574;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\loading.html";i:1468203746;s:68:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\nav.html";i:1468396422;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\sidebar.html";i:1468812703;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\script.html";i:1468808902;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\modal.html";i:1468203746;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\danger.html";i:1468227114;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="widget-body">
                        ...
                        <validator name="addAdValidation">
                            <form class="form-horizontal" role="form" novalidate>
                                <input type="hidden" value="<?php echo $ad['id']; ?>" v-model="ad.id">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="e1" name="positionId" class="input-label" v-validate:positionId="{ required: true}" v-model="ad.positionId">
                                            ...
                                            <option value="1" <?php if($ad->getData('positionId') == 1): ?>selected="true"<?php endif; ?>/>手机首页广告
                                            <option value="2"  <?php if($ad->getData('positionId') == 2): ?>selected="true"<?php endif; ?>/>手机活动广告
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name" class="form-control input-label"  placeholder="活动名称" v-validate:name="{ required: true}" v-model="ad.name" value="<?php echo $ad['name']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="input" class="col-sm-2 control-label no-padding-right">开始时间</label>
                                    <div class="col-sm-10">
                                        <input name="act_start_time" type="text" class="text-box" placeholder="请选择活动开始时间" readonly="readonly" style="cursor:pointer;" v-model="ad.start_time" v-validate:start_time="{ required: true}" name="start_time" value="<?php echo $ad['start_time']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="act_stop_time" type="text" class="text-box" placeholder="请选择活动结束时间"  readonly="readonly" style="cursor:pointer;"
                                         v-model="ad.end_time" v-validate:end_time="{ required: true}" name="end_time" value="<?php echo $ad['end_time']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="input" class="col-sm-2 control-label no-padding-right">广告排序</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control input-label" name="sort" placeholder="广告排序" v-model="ad.sort" v-validate:sort="{ required: true}" value="<?php echo $ad['sort']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="input" class="col-sm-2 control-label no-padding-right">广告链接</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control input-label" name="sort" placeholder="广告链接" v-model="ad.url" value="<?php echo $ad['url']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="input" class="col-sm-2 control-label no-padding-right">广告图片</label>
                                    <div class="col-sm-10">
                                        <img src="<?php echo (isset($ad['file']) && ($ad['file'] !== '')?$ad['file']:'/static/load.png'); ?>" style="width:500px;height: 300px;margin-top:10px ;" id="ad"  class="upload">
            ...
            addAd: function () {
                this.ad.file = $('#ad').attr('src');
                    $.ajax({
                        ...
                        success: function(data) {
                            if(data.status>0){
                                window.success({msg:"修改成功",url:"<?php echo url('Admin/ad/index'); ?>"});
                            }else{
