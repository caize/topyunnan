<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\upload\index.html";i:1468573834;}*/ ?>
...
$(function(argument) {
  $("#upload-input").fileinput({
    ...
    bootbox.hideAll();
    $('#<?php echo $id; ?>').attr('src',response.file);
