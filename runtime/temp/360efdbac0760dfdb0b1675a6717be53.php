<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:69:"D:\phpStudy\WWW\cms\public/../application/admin\view\article\add.html";i:1469077014;s:67:"D:\phpStudy\WWW\cms\public/../application/admin\view\base\base.html";i:1468380670;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\style.html";i:1468817574;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\loading.html";i:1468203746;s:68:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\nav.html";i:1468396422;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\sidebar.html";i:1468812703;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\script.html";i:1468808902;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\modal.html";i:1468203746;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\danger.html";i:1468227114;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="widget-body">
                        ...
                        <validator name="addArticleValidation">
                            <form class="form-horizontal" role="form" novalidate>
                                ...
                                <input type="hidden" v-model="article.id" value="0">
                                    ...
                                    <div class="col-sm-10">
                                          <select id="e1" name="parent_id" class="input-label" v-model="article.category_id">
                                             <?php if(is_array($cates) || $cates instanceof \think\Collection): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $vo['id']; ?>" /><?php echo $vo['title']; if(is_array($vo->parent) || $vo->parent instanceof \think\Collection): $i = 0; $__LIST__ = $vo->parent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $ko['id']; ?>" />------<?php echo $ko['title']; endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" name="author" class="form-control input-label"  placeholder="标题" v-validate:author="{ required: true}" v-model="article.author">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    <img src="/static/load.png" style="width:500px;height: 300px;margin-top:10px ;" id="article"  class="upload">
        ...
        methods: {
            addArticle: function () {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data.status>0){
                            success({msg:"添加成功",url:'<?php echo url("Admin/article/index"); ?>'});
                        }else{
                            error({msg:data.msg});
                        }
                    },
