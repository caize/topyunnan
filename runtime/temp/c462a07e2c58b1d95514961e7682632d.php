<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:66:"D:\phpStudy\WWW\cms\public/../application/admin\view\ad\index.html";i:1469528318;s:67:"D:\phpStudy\WWW\cms\public/../application/admin\view\base\base.html";i:1468380670;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\style.html";i:1468817574;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\loading.html";i:1468203746;s:68:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\nav.html";i:1468396422;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\sidebar.html";i:1468812703;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\script.html";i:1468808902;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\modal.html";i:1468203746;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\danger.html";i:1468227114;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="table-toolbar">
                          <?php if(in_array(43,$auth)): ?>
                            <a id="editabledatatable_new" href="<?php echo url('admin/ad/add'); ?>" class="btn btn-default">
                                广告添加
                            </a>
                          <?php endif; ?>
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                            ...
                            <td style="width: 50px"><?php echo $vo['id']; ?></td>
                                ...
                                <td><?php echo $vo['positionId']; ?></td>
                                <td><?php echo $vo['start_time']; ?></td>
                                <td><?php echo $vo['end_time']; ?></td>
                                <td>
                                    <?php if(in_array(39,$auth)): ?>
                                    <a class="btn btn-info btn-xs edit" href="<?php echo url('admin/ad/edit',['id'=>$vo['id']]); ?>"><i class="fa fa-edit"></i>编辑</a>
                                    <?php endif; if(in_array(40,$auth)): ?>
                                    <a class="btn btn-danger btn-xs delete" href="javascript:adDelete(<?php echo $vo['id']; ?>)"><i class="fa fa-trash-o"></i>删除</a>
                                    <?php endif; ?>
                                </td>
                                </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        function adDelete(id)
        {
            bootbox.confirm("是否删除该广告", function (result) {
                if (result) {
                    $.ajax({
                        type: "POST",
                        url: '<?php echo url("admin/ad/delete"); ?>',
                        dataType: 'json',
                        cache: false,
                        data:{id:id},
                        success: function(data) {
