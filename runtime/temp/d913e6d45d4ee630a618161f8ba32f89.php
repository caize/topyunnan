<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:76:"D:\phpStudy\WWW\cms\public/../application/admin\view\article_cate\index.html";i:1468572814;s:67:"D:\phpStudy\WWW\cms\public/../application/admin\view\base\base.html";i:1468380670;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\style.html";i:1468817574;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\loading.html";i:1468203746;s:68:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\nav.html";i:1468396422;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\sidebar.html";i:1468812703;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\script.html";i:1468808902;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\modal.html";i:1468203746;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\danger.html";i:1468227114;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="table-toolbar">
                          <?php if(in_array(20,$auth)): ?>
                            <a id="editabledatatable_new" href="<?php echo url('admin/articleCate/add'); ?>" class="btn btn-default">
                                分类添加
                            </a>
                          <?php endif; ?>                          
                            ...
                            <tbody>
                                <?php if(is_array($cates) || $cates instanceof \think\Collection): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr class="success">
                                        ...
                                        <td>
                                            <?php if(in_array(22,$auth)): ?>
                                            <a class="btn btn-info btn-xs edit" href="<?php echo url('admin/articleCate/edit',['id'=>$vo['id']]); ?>"><i class="fa fa-edit"></i>编辑</a>
                                            <?php endif; if(in_array(21,$auth)): ?>
                                            <a class="btn btn-danger btn-xs delete" href="javascript:cateDelete(<?php echo $vo['id']; ?>)"><i class="fa fa-trash-o"></i>删除</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php if(is_array($vo->parent) || $vo->parent instanceof \think\Collection): $i = 0; $__LIST__ = $vo->parent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?>
                                        <tr class="active">
                                            <td><?php echo $ko['id']; ?></td>
                                            <td class="text-left">┗━<?php echo $ko['title']; ?></td>
                                            <td>
                                                <?php if(in_array(22,$auth)): ?>
                                                <a class="btn btn-info btn-xs edit" href="<?php echo url('admin/articleCate/edit',['id'=>$ko['id']]); ?>"><i class="fa fa-edit"></i>编辑</a>
                                                <?php endif; if(in_array(21,$auth)): ?>
                                                <a class="btn btn-danger btn-xs delete" href="javascript:cateDelete(<?php echo $ko['id']; ?>)"><i class="fa fa-trash-o"></i>删除</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                        <tr>
                                            <td colspan="7" rowspan=""><?php echo $cates->render(); ?></td>
                                        </tr>
                            </tbody>
                        </table>
                    </div>
