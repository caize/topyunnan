<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:67:"D:\phpStudy\WWW\cms\public/../application/admin\view\sys\index.html";i:1469527589;s:67:"D:\phpStudy\WWW\cms\public/../application/admin\view\base\base.html";i:1468380670;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\style.html";i:1468817574;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\loading.html";i:1468203746;s:68:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\nav.html";i:1468396422;s:72:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\sidebar.html";i:1468812703;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\script.html";i:1468808902;s:70:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\modal.html";i:1468203746;s:71:"D:\phpStudy\WWW\cms\public/../application/admin\view\public\danger.html";i:1468227114;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php if($vo['type'] == 'text'): ?>
                                        <input type="text" class="form-control input-label" id="<?php echo $vo['code']; ?>" v-model="config.<?php echo $vo['code']; ?>" name='<?php echo $vo['code']; ?>' value="<?php echo $vo['content']; ?>">
                                        <?php endif; if($vo['type'] == 'textarea'): ?>
                                        <textarea class="form-control input-label" placeholder="Content" name="<?php echo $vo['code']; ?>" style='height:100px;' v-model="config.<?php echo $vo['code']; ?>" id="<?php echo $vo['code']; ?>"><?php echo $vo['content']; ?></textarea>
                                        <?php endif; if($vo['type'] == 'upload'): ?>
                                        <img src="<?php echo (isset($vo['content']) && ($vo['content'] !== '')?$vo['content']:'/mobile/img/jia.png'); ?>" style="max-width:100px; max-height:100px;" id="<?php echo $vo['code']; ?>"  class="img-circle upload">
                                        <input type="hidden" name="<?php echo $vo['code']; ?>" value="<?php echo $vo['content']; ?>"/>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    new Vue({
      ...
      methods: {
        saveConfig: function () {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo url("admin/sys/index"); ?>',
                dataType: 'json',
                cache: false,
                data: this.config,
                success: function(data) {
